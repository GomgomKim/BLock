...
public class SetHost {
    ...
    public SetHost(Context context, String user_id, String address) throws ExecutionException, InterruptedException {
...
//           credentials = Credentials.create(web3j.ethAccounts().send().getAccounts().get(0));
        ...
        Thread chain_thread = new Thread(() -> {
            try {
                ...
                ////////
                TransactionReceipt transactionReceipt = greeter.setHost(USERID);
                ////////
